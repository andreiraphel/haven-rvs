          ...
          {step === "vulnerability" && (
            <div className="space-y-6">
              ...
              <Section title="C1 — Structural System">
                ...
                <QField label="C1.10 Wall Material" sub="Low (Reinforced Concrete) ; Moderate (Reinforced Masonry, Hybrid(Concrete and Wood)) ; High (Unreinforced Masonry, Glass, Wood, Bamboo)"><QualitativeSelect multiple value={vuln.wall_material ?? []} options={["Reinforced Concrete", "Reinforced Masonry", "Hybrid(Concrete and Wood)", "Unreinforced Masonry", "Wood", "Bamboo", "Glass"]} onChange={v => setV("wall_material",v)} /></QField>
