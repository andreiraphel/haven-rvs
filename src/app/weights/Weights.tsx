...
const WEIGHT_LABELS: Record<string, string> = {
  ...
  slope: "A3.1 Slope / Gradient",
  elevation: "A3.2 Elevation (m)",
  water_distance: "A3.3 Dist. to Water (m)",
  runoff: "A3.4 Surface Runoff",
  base_height: "A3.5 Base Height",
  drainage: "A3.6 Drainage System",
  // Exposure (B)
